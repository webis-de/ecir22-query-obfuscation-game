...
spark-submit \
        ...
        --executor-memory 10G\
        ${JAR_FILE} \
		--input file:///mnt/ceph/storage/data-in-progress/data-teaching/theses/wstud-thesis-libera/document-sample/all-docs.csv \
		--index cw12 \
		--output thesis-libera/document-sample.jsonl \
